...
public class MySQLTableCreator {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 注意删除顺序先删带foreign key的table，再删原table
            ...
            // 注意创建顺序相反，先创建没有foriegn key的table
            ...
            sql = "CREATE TABLE favorite_records ("
                    ...
                    + "last_favor_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP," // 不提供时间就默认当前时间
